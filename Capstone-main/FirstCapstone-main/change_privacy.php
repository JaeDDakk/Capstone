      ...
      <div class="input-form col-md-12 mx-auto">
        ...
        oninput='pwd2.setCustomValidity(pwd2.value != pwd.value ? "비밀번호가 일치하지 않습니다!" : "")'>    
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="id" name="id" placeholder="전화번호를 입력해주세요" required>
            <div class="invalid-feedback">
                번호를 입력해주세요.
              </div>
              ...
              <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="id" name="id" placeholder="주소를 입력해주세요" required>
