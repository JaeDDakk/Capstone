...
<html lang="kr">
    ...
    <script>
        jQuery(function($){
            $("#foo-table").DataTable({lengthChange: false, searching: false,ordering: false,info: false,paging: false});
        });
    </script>
    </head>
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Sal.com</a>
            <!-- Sidebar Toggle-->
                                        ...
                                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                         ...
                                         <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                             <nav class="sb-sidenav-menu-nested nav">
                                                 ...
                                                 <a class="nav-link" href="change_pw.html">비밀번호 변경</a>
                                                 <a class="nav-link" href="change_privacy.html">개인 정보 변경</a>
                                             </nav>
                                         </div>
                                        </div>
